...
- WaRTEm-AD: Developed a warping resilient model for anomaly detection in univariate time series data with help of novel warp operators, data augmentation and Twin Autoencoder model [[Code]](https://github.com/WaRTEm-AD/UnivariateAnomalydetection)
- DXtreMM: Developed a deep model for extreme event prediction in time series combined with a mixture of probability distributions [[Code]](https://github.com/DXtreMM/DXtreMM_TSF)
- WRADMts: Developed a similarity based alignment technique for multivariate time series data for anomaly detection considering temporal and intervariable dependencies [[Code]](https://github.com/Abilasha-S/Diffeo-RADMts)

<h1> Teaching Experience </h1>

<strong> Teaching Assistant, IIT Palakkad </strong>
